...
outer_grid = gridspec.GridSpec(3,2,width_ratios=[1,1],height_ratios=[1,1.5,1.5],wspace=0.3,hspace=0.6)
...
schem_nut_axis.set_xlabel('Nutrient concentration, n', labelpad=1)
...
pug_qwm_axis = plt.Subplot(fig, outer_grid[1,0])
fig.add_subplot(pug_qwm_axis)
pug_qwm_axis.set_title('Quasi Well-Mixed Regime')


pug_spa_axis = plt.Subplot(fig, outer_grid[2,0])
fig.add_subplot(pug_spa_axis)
pug_spa_axis.set_xlabel('Position, $x$ (a.u.)')
pug_spa_axis.set_title('Spatial Regime')


schem_pos_axis = plt.Subplot(fig, outer_grid[0,1])
fig.add_subplot(schem_pos_axis)
schem_pos_axis.set_ylabel('$\\lambda(x)$',labelpad=2.0)
schem_pos_axis.set_xticks([25])
schem_pos_axis.set_xticklabels('l')
...
lame_axis = plt.Subplot(fig, outer_grid[1,1])
fig.add_subplot(lame_axis)
lame_axis.set_ylabel('$\\lambda_e/\\lambda$')

ne_axis = plt.Subplot(fig, outer_grid[2,1])
fig.add_subplot(ne_axis)
ne_axis.set_xlabel('$\\alpha-1')
ne_axis.set_ylabel('$\\frac{N_e}{N}\\frac{vL}{D}$')
...
schem_nut_axis.plot(x1, step_lambda_nutrients(len(x1)))
schem_pos_axis.plot(x1, step_lambda(len(x1)))
